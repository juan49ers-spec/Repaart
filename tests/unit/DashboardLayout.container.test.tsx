...
vi.mock('../../src/components/ImpersonationBanner', () => ({
...
vi.mock('../../src/layouts/components/BottomTabBar', () => ({
  default: () => <nav data-testid="bottom-tab-bar">TabBar</nav>
}));

vi.mock('../../src/layouts/components/ChatAssistant', () => ({
  default: () => <div data-testid="chat-assistant">Chat</div>
}));

vi.mock('../../src/components/ui/modals/PageHelpModal', () => ({
