...
exports.sendPushNotification = exports.unsubscribeFromPush = exports.subscribeToPush = void 0;
...
exports.unsubscribeFromPush = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be logged in');
    }
    const userId = context.auth.uid;
