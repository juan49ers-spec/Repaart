            ...
            <div className="max-w-[1920px] mx-auto px-4 lg:px-6 h-16 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className="lg:hidden group p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 focus:outline-none"
                    >
                ...
                <nav className="hidden lg:flex items-center gap-1 justify-center bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-full px-2 py-1.5 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] mx-auto">
