...
interface RiderSecurityViewProps {
    /** When true, hides the page shell (header + full-screen wrapper) for inline embedding */
    compact?: boolean;
}

export const RiderSecurityView: React.FC<RiderSecurityViewProps> = ({ compact = false }) => {
