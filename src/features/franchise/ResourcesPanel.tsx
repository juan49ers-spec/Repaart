            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between p-8 pb-4 relative z-10">
                ...
                <div className="flex items-center gap-3 mt-4 md:mt-0">
                    <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-md p-1 rounded-xl border border-white/60 dark:border-slate-800 flex shadow-sm">
                        <button onClick={() => setViewMode('list')} className={`p-2 rounded-lg transition-all ${viewMode === 'list' ? 'bg-white dark:bg-slate-800 text-indigo-600 dark:text-white shadow-sm' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}>
                            <ListIcon className="w-5 h-5" />
                        </button>
                        <button onClick={() => setViewMode('grid')} className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-white dark:bg-slate-800 text-indigo-600 dark:text-white shadow-sm' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}>
