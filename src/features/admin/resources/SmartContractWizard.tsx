                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 px-12 py-8">
                                            <div className="prose prose-slate max-w-none prose-sm !text-slate-800 selection:bg-indigo-100 [&_p]:!text-[11px] [&_p]:!leading-[1.75] [&_p]:!mb-2 [&_h1]:!text-[14px] [&_h1]:!font-black [&_h1]:!uppercase [&_h1]:!tracking-tight [&_h1]:!mt-5 [&_h1]:!mb-2 [&_h2]:!text-[12px] [&_h2]:!font-extrabold [&_h2]:!uppercase [&_h2]:!tracking-wide [&_h2]:!mt-4 [&_h2]:!mb-1.5 [&_h3]:!text-[11px] [&_h3]:!font-bold [&_h3]:!mt-3 [&_h3]:!mb-1 [&_ul]:!text-[10.5px] [&_ul]:!leading-[1.6] [&_ol]:!text-[10.5px] [&_ol]:!leading-[1.6] [&_li]:!text-[10.5px] [&_li]:!mb-0.5 [&_strong]:!font-extrabold [&_hr]:!my-4 [&_table]:!text-[10px] [&_td]:!py-1 [&_th]:!py-1 font-serif">
