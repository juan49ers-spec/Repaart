# 🛡️ VEREDICTO V4: AUTORIZACIÓN Y CIERRE DEFINITIVO (EVIDENCIA ABSOLUTA)
...
Con esta iteración **V4**, se declaran cerrados todos los blockers identificados:
...
5. **Rigor de Integridad Field-by-Field:** Los riders tienen una *whitelist* inmutable a la hora de editar sus turnos en vivo. El uso de `affectedKeys().hasOnly(...)` en Firestore Rules impide estrictamente sobreescribir identificadores o metas operativas (`franchiseId`, `date`, `times`).
