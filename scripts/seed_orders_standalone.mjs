 ...
 * Ejecutar con: node scripts/seed_orders_standalone.mjs
 */

import { initializeApp } from 'firebase-admin/app';
import { getFirestore, Timestamp, collection, addDoc } from 'firebase-admin/firestore';
...
const firebaseConfig = {
  projectId: process.env.VITE_FIREBASE_PROJECT_ID || 'repaartfinanzas',
...
try {
  ...
  console.log('💡 Usando Firebase directamente sin autenticación');
  
  // Fallback: usar firebase-app/client si está disponible
  try {
    ...
    console.error('❌ No se pudo inicializar Firebase client:', clientError);
    process.exit(1);
  }
}
